...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                new Product() { ProductId = 1, CategoryId = 2, ImageUrl="/images/1.jpg", ProductName = "Computer", Price = 20000 },
                new Product() { ProductId = 2, CategoryId = 2, ImageUrl="/images/2.jpg", ProductName = "Keybord", Price = 1000 },
